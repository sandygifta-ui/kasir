...
class TambahKategoriActivity : AppCompatActivity() {
    ...
    private val listKategori = arrayOf("Lips", "Face", "Eyes", "Skincare")
    ...
    private fun bukaKamera() {
        ...
        uriKamera = FileProvider.getUriForFile(
            this,
            "${packageName}.fileprovider",
            file
        )
        bukaKameraLauncher.launch(uriKamera)
    }
}